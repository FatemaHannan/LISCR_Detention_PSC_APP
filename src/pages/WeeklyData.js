...
const UPLOADS = [
  ...
  },
  {
    ...
    exportColumns: {
      vessel: "Vessel", imo: "IMO", mou_zone: "Mou Zone", action_type: "Action Type",
      action_status: "Action Status", case_file_port: "Case File Port", country: "Country",
      vsl_score: "Vsl Score", risk_level: "Risk Level", dpp_arrival_risk: "DPP Arrival Risk That Day",
      dpp_risk_lvl: "DPP Risk Lvl That Day", paris_target_risk: "DPP PARIS MOU Target Risk That Day",
      tokyo_target_risk: "DPP TOKYO MOU Target Risk That Day", uscg_target_risk: "DPP USCG Target RSK That Day",
      amsa_target_risk: "DPP AMSA MOU Target Risk That Day", latest_note: "Latest Case File Note",
    },
    map: (r) => ({
      vessel: String(r["Vessel"]||r["vessel"]||"").trim(),
      imo: String(r["IMO"]||r["IMONumber"]||r["imo"]||"").replace(/[^0-9]/g,""),
      mou_zone: String(r["Mou Zone"]||r["mou_zone"]||"").trim(),
      action_type: String(r["Action Type"]||r["action_type"]||"").trim(),
      action_status: String(r["Action Status"]||r["action_status"]||"").trim(),
      case_file_port: String(r["Case File Port"]||r["case_file_port"]||"").trim(),
      country: String(r["Country"]||r["country"]||"").trim(),
      vsl_score: parseFloat(r["Vsl Score"]||r["vsl_score"])||0,
      risk_level: String(r["Risk Level"]||r["risk_level"]||"").trim(),
      dpp_arrival_risk: String(r["DPP Arrival Risk That Day"]||r["dpp_arrival_risk"]||"").trim(),
      dpp_risk_lvl: String(r["DPP Risk Lvl That Day"]||r["dpp_risk_lvl"]||"").trim(),
      paris_target_risk: String(r["DPP PARIS MOU Target Risk That Day"]||r["paris_target_risk"]||"").trim(),
      tokyo_target_risk: String(r["DPP TOKYO MOU Target Risk That Day"]||r["tokyo_target_risk"]||"").trim(),
      uscg_target_risk: String(r["DPP USCG Target RSK That Day"]||r["uscg_target_risk"]||"").trim(),
      amsa_target_risk: String(r["DPP AMSA MOU Target Risk That Day"]||r["amsa_target_risk"]||"").trim(),
      latest_note: String(r["Latest Case File Note"]||r["latest_note"]||"").trim().slice(0,500),
    }),
    filter: (r) => (r["Vessel"]||r["vessel"]) && (r["IMO"]||r["IMONumber"]||r["imo"]),
  },
];
