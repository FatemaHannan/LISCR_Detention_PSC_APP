...
const UPLOADS = [
  ...
  {
    key: "stricken_vessels",
    onConflictKey: "imo",
    label: "Stricken Vessels",
    desc: "Deregistered/removed-from-Liberian-flag vessels — kept as a fallback source for ship type, company, RO, and other details that no longer appear in the active Fleet Roster",
    icon: "ti-ship-off", color: "var(--text3)", bg: "var(--bg3)",
    table: "stricken_vessels",
    exportColumns: {
      vessel:"Vessel", imo:"IMO", vessel_type:"Vessel Type", ism_client:"ISM Client", ro:"RO",
      regional_office:"Regional Office", age:"Age", reg_date:"Reg Date", stricken_date:"Stricken Date",
      gross_tons:"Gross Tons", flag_state:"Flag State", notes:"Notes",
    },
    filter: (r) => s(r["Vessel"]||r["vessel"]) && s(r["IMO"]||r["imo"]),
    map: (r) => ({
      vessel: s(r["Vessel"]||r["vessel"]),
      ...
      regional_office: s(r["Regional Office"]||r["regional_office"]),
      age: n(r["Age"]||r["age"]),
      reg_date: d(r["Reg Date"]||r["reg_date"]),
      stricken_date: d(r["Stricken Date"]||r["stricken_date"]),
      gross_tons: n(r["Gross Tons"]||r["gross_tons"]),
      flag_state: s(r["Flag State"]||r["flag_state"]),
  ...
  },
  {
    ...
    exportColumns: {
      ...
      flag_control_or_det_365:"Flag Control or Det Last 365", previous_flag:"Previous Flag",
      flag_transfer_date:"Flag Transfer Date",
    },
    filter: (r) => s(r["Vessel"]||r["vessel"]) && s(r["IMO"]||r["imo"]),
    map: (r) => ({
      vessel: s(r["Vessel"]||r["vessel"]),
  ...
  },
  {
    ...
    onConflictKey: "imo,inspection_date,flag_psc,inspection_type",
