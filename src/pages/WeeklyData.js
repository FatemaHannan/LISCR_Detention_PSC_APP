  ...
  },,
  {
    ...
    map: (r) => {
      ...
      return {
        vessel: s(r["Vessel"]||r["vessel"]),
        imo: imoStr,
        ism_client: s(r["ISM Client"]),
        vsl_type: s(r["Vsl Type"]),
        ro: s(r["RO"]),
        age: r["Age"]!=null?Number(r["Age"])||null:null,
        fsc: r["FSC"]!=null?Number(r["FSC"])||null:null,
        flag_insps: r["#FLAG INSPs"]!=null?parseInt(r["#FLAG INSPs"])||null:null,
        flag_finding_av: r["Flag Finding Av."]!=null?Number(r["Flag Finding Av."])||null:null,
        psc_insps: r["#PSC INSPs"]!=null?parseInt(r["#PSC INSPs"])||null:null,
        psc_finding_av: r["PSC Finding Av."]!=null?Number(r["PSC Finding Av."])||null:null,
        num_detentions: r["# Detentions"]!=null?parseInt(r["# Detentions"])||null:null,
        psc_det_pct: r["PSC Det %"]!=null?Number(r["PSC Det %"])||null:null,
        avg_insp_findings: r["Average of INSP Findings"]!=null?Number(r["Average of INSP Findings"])||null:null,
        tech_disp_365: r["Tech DISP 365"]!=null?parseInt(r["Tech DISP 365"])||null:null,
        vsl_insp_perf: r["VSL INSP PERF"]!=null?Number(r["VSL INSP PERF"])||null:null,
        us_trading: s(r["US Trading"]),
        vsl_casualty: r["VSL Casualty"]!=null?parseInt(r["VSL Casualty"])||null:null,
        mlc_compl: r["MLC COMPL"]!=null?parseInt(r["MLC COMPL"])||null:null,
        flag_control_det_365: r["Flag Control or Det Last 365"]!=null?parseInt(r["Flag Control or Det Last 365"])||null:null,
        flag_followup_rcm: s(r["Flag Follow-Up RCM"]),
        psc_followup_rcm: s(r["PSC Follow-Up RCM"]),
      };
    },
  },
];
